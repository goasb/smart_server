...
/** 
 * 1.마우스 또는 키보드 포커스처리시, 하위메뉴 전체가 나타나게 만들기 (배경 하얗게)
 * 2.마우스 또는 키보드 포커스처리시, 하위메뉴 전체가 나타나게 만들기 (별도 배경없이)
 * 3.마우스 또는 키보드 포커스처리시, 해당메뉴 하위하나만 나타나게 만들기
 */  
...
/*      gnb.css({'backgroundColor':'transparent'});
     ...
     'boxShadow':'0.2rem 0.2rem 0.2rem 0.2rem rgba(0,0,0,0.3)'});
